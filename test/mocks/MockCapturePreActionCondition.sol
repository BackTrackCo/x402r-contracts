...
/**
 * @title MockCapturePreActionCondition
 * @notice Mock release condition for testing - allows manual approval of releases
 * @dev Implements IPreActionCondition - returns bool instead of reverting
 */
contract MockCapturePreActionCondition is IPreActionCondition {
