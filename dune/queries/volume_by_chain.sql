...
--
-- Factory addresses: both legacy per-chain factories AND unified CREATE3 factory (0xdc41F932...)
--
...
WITH operators AS (
    ...
    WHERE contract_address IN (0x3D0837fF8Ea36F417261577b9BA568400A840260, 0xdc41F932dF2d22346F218E4f5650694c650ab863)
    ...
    WHERE contract_address IN (0x1e52a74cE6b69F04a506eF815743E1052A1BD28F, 0xdc41F932dF2d22346F218E4f5650694c650ab863)
      AND topic0 = 0xecf5e5f1fec1eb36d3fb535d9f789157daaaef2d1dce54e4c09b5631ae9efa10
    UNION ALL
    SELECT 'polygon', bytearray_substring(topic1, 13, 20) FROM polygon.logs
    WHERE contract_address IN (0xb33D6502EdBbC47201cd1E53C49d703EC0a660b8, 0xdc41F932dF2d22346F218E4f5650694c650ab863)
      AND topic0 = 0xecf5e5f1fec1eb36d3fb535d9f789157daaaef2d1dce54e4c09b5631ae9efa10
    UNION ALL
    SELECT 'arbitrum', bytearray_substring(topic1, 13, 20) FROM arbitrum.logs
    WHERE contract_address IN (0x32d6AC59BCe8DFB3026F10BcaDB8D00AB218f5b6, 0xdc41F932dF2d22346F218E4f5650694c650ab863)
      AND topic0 = 0xecf5e5f1fec1eb36d3fb535d9f789157daaaef2d1dce54e4c09b5631ae9efa10
    UNION ALL
    ...
    WHERE contract_address IN (0x32d6AC59BCe8DFB3026F10BcaDB8D00AB218f5b6, 0xdc41F932dF2d22346F218E4f5650694c650ab863)
      AND topic0 = 0xecf5e5f1fec1eb36d3fb535d9f789157daaaef2d1dce54e4c09b5631ae9efa10
    UNION ALL
    SELECT 'linea', bytearray_substring(topic1, 13, 20) FROM linea.logs
    WHERE contract_address = 0xdc41F932dF2d22346F218E4f5650694c650ab863
      AND topic0 = 0xecf5e5f1fec1eb36d3fb535d9f789157daaaef2d1dce54e4c09b5631ae9efa10
),
...
raw_logs AS (
    ...
    UNION ALL
    SELECT 'linea', topic0, data, contract_address FROM linea.logs
    WHERE topic0 IN (0x25a881a7e96f8ce977da598bc17f91f1235aa59b7a2abad5f454f317c7ff2c9d,
                     0xdb91bd6597cd642062d7480a3e7a9510af3cac44b224cf7ae9357a8e18af0d00)
      AND contract_address IN (SELECT operator FROM operators WHERE chain = 'linea')
),
