...
contract DeployNotConditionFactory is Create3Deployer {
    function run() external {
        ...
        address deployed = _deploy3(label, salt, abi.encodePacked(type(NotConditionFactory).creationCode));
        console.log("NotConditionFactory:", deployed);
        vm.stopBroadcast();
    }
}
