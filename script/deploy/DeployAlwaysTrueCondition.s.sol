...
contract DeployAlwaysTrueCondition is Create3Deployer {
    function run() external {
        ...
        address deployed = _deploy3(label, salt, abi.encodePacked(type(AlwaysTrueCondition).creationCode));
        console.log("AlwaysTrueCondition:", deployed);
        vm.stopBroadcast();
    }
}
