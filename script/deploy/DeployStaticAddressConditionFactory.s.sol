...
contract DeployStaticAddressConditionFactory is Create3Deployer {
    function run() external {
        ...
        address deployed = _deploy3(label, salt, abi.encodePacked(type(StaticAddressConditionFactory).creationCode));
        console.log("StaticAddressConditionFactory:", deployed);
        vm.stopBroadcast();
    }
}
