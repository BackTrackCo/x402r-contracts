...
contract DeploySignatureConditionFactory is Create3Deployer {
    function run() external {
        ...
        address deployed = _deploy3(label, salt, abi.encodePacked(type(SignatureConditionFactory).creationCode));
