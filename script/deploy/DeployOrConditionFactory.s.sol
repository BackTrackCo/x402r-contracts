...
contract DeployOrConditionFactory is Script {
    ...
    function run() external {
        ...
        address deployed = _deploy3(label, abi.encodePacked(type(OrConditionFactory).creationCode));
        console.log("OrConditionFactory:", deployed);
