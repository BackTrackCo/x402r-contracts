...
contract DeployReceiverRefundCollector is Create3Deployer {
    function run() external {
        ...
        address deployed =
            _deploy3(label, salt, abi.encodePacked(type(ReceiverRefundCollector).creationCode, abi.encode(escrow)));
