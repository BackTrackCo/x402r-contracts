...
contract DeployRecorderCombinatorFactory is Create3Deployer {
    function run() external {
        ...
        address deployed = _deploy3(label, salt, abi.encodePacked(type(RecorderCombinatorFactory).creationCode));
        console.log("RecorderCombinatorFactory:", deployed);
        vm.stopBroadcast();
    }
}
